            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="allbooks.html">查看所有项目</a></li>
                        <li class="divider"></li>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="book_edit_do.html?id=${detail.bookId}" method="post" id="addbook" >
                ...
                <div class="input-group">
                    <span class="input-group-addon">旅游项目名</span>
                ...
                <div class="input-group">
                    <span  class="input-group-addon">人均价格</span>
                    <input type="text" class="form-control" name="price"  id="price" value="${detail.price}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">上架日期</span>
